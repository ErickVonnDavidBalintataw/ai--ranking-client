...
const RecordSubmissionForm = ({ selectedSdg, selectedYear }) => {
  ...
  useEffect(() => {
    const calculateTotalScore = () => {
      const scores = Array.from(document.querySelectorAll("td.score")).map(
                      ...
                      instrument.section_contents.map(
                        (section, sectionIndex) => (
                          <React.Fragment key={section.section_id}>
                            ...
                            <tr>
                              <td
                                colSpan={flattenedCampuses.length}
                            ...
                            <tr>
                              ...
                              >
                                <div key={section.section_id}>
                                  <label htmlFor={`file-${section.section_id}`}>
                                    Upload files for
                                  </label>
                                  <br />
                                  <input
                                    ...
                                    multiple
                                    onChange={(e) =>
                                      handleFileChange(e, section.section_id)
                                    }
                                  />
                                  {sectionFiles[section.section_id] && (
                                    <ul>
                                      {fileData[section.section_id].map(
                                        (file, index) => (
