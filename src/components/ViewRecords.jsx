        ...
        const updatedInstruments = await Promise.all(
          instrumentData.map(async (instrument) => {
            const sectionsResponse = await fetch(
              `https://ai-impact-ranking-server.onrender.com/api/get/sections/${instrument.instrument_id}`
            );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const sendAnswers = async () => {
        const url =
          "https://ai-impact-ranking-server.onrender.com/api/add/answers";
