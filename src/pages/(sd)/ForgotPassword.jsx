    ...
    <section className="h-screen">
      <div className="flex justify-center items-center h-full">
        <div className="form__container w-2/5 h-full flex items-center">
          <form
            className="p-10"
            onSubmit={isOTPVerified ? handleResetPassword : handleSubmit}
          >
            <div className="form__header mb-10">
              <h1 className="text-2xl">
                Center for Sustainable Development Office
              </h1>
              <h3 className="text-xl">Batangas State University - TNEU</h3>
            </div>
        ...
        <div className="bg__container w-3/5 h-full">
          <img src={loginBG} alt="login-bg" className="h-full object-cover" />
        </div>
      </div>
    </section>
  );
