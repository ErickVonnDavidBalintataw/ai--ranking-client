...
const EditInstrument = () => {
    ...
    const fetchInstrumentAndSections = async () => {
      try {
        ...
        const iResponse = await fetch(
          `https://ai-impact-ranking-server.onrender.com/api/get/instrument-by-instrument-id/${instrument_id}`
        );
        const iData = await iResponse.json();
        console.log(iData, "asd");
        // Fetch sections data
        const sectionsResponse = await fetch(
          `https://ai-impact-ranking-server.onrender.com/api/get/section-by-instrument-id/${instrument_id}`
        );
        ...
        //                 options: await fetch(
        //                     `https://ai-impact-ranking-server.onrender.com/api/get/options/${question.question_id}`
  ...
  const handleQuestionTypeChange = (e, sectionIndex, questionIndex) => {
    const { value } = e.target;
    const updatedSections = [...instrumentData.sections];
    updatedSections[sectionIndex].questions[questionIndex].questionType = value;
  ...
  const removeOption = (sectionIndex, questionIndex, optionIndex) => {
    const updatedSections = [...instrumentData.sections];
    updatedSections[sectionIndex].questions[questionIndex].options =
      updatedSections[sectionIndex].questions[questionIndex].options.filter(
    ...
    const updatedInstrument = async () => {
      try {
        const response = await fetch(
          `https://ai-impact-ranking-server.onrender.com/api/update/instrument/${instrumentData.instrument_id}`,
          {
            method: "PATCH",
            headers: {
        ...
        if (response.ok) {
          instrumentData.sections.map(async (section) => {
            ...
            if (section.section_id) {
              const response = await fetch(
                `https://ai-impact-ranking-server.onrender.com/api/update/section/${section.section_id}`,
                {
                  method: "PATCH",
                  headers: {
                    "Content-Type": "application/json",
              ...
              const response = await fetch(
                `https://ai-impact-ranking-server.onrender.com/api/add/sections/`,
                {
                  method: "POST",
                  headers: {
                    "Content-Type": "application/json",
            ...
            section.questions.map(async (question) => {
              ...
              if (question.question_id) {
                ...
                const response = await fetch(
                  `https://ai-impact-ranking-server.onrender.com/api/update/question/${question.question_id}`,
                  {
                    method: "PATCH",
                    headers: {
                      "Content-Type": "application/json",
                ...
                // Add new question
                const response = await fetch(
                  `https://ai-impact-ranking-server.onrender.com/api/add/questions/`,
                  {
                    method: "POST",
                    headers: {
                      "Content-Type": "application/json",
              ...
              question.options &
                question.options.map(async (option) => {
                  ...
                  if (option.option_id) {
                    ...
                    const response = await fetch(
                      `https://ai-impact-ranking-server.onrender.com/api/update/options/${option.option_id}`,
                      {
                        method: "PATCH",
                        headers: {
                          "Content-Type": "application/json",
                    ...
                    // Add new option
                    const response = await fetch(
                      `https://ai-impact-ranking-server.onrender.com/api/add/options/`,
                      {
                        method: "POST",
                        headers: {
                          "Content-Type": "application/json",
        ...
        <div className="py-5 px-7">
          <form onSubmit={handleSubmit}>
            ...
            <div className="border px-3 py-2">
              {instrumentData.sections.map((section, sectionIndex) => (
                <div key={sectionIndex} className="section-group my-4">
                  <hr
                    className={`${sectionIndex === 0 ? "hidden my-4" : "my-4"}`}
                  />
                    ...
                    <div className="input-group w-[80%]">
                      <label className="form-control w-full">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleSectionContentChange(e, sectionIndex)
                          }
                          required
                        />
                      </label>
