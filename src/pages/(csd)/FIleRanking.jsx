    ...
    const getSdgData = async () => {
      try {
        const sdgResponse = await fetch(
          "https://ai-impact-ranking-server.onrender.com/api/get/records-count-per-sdg"
        );
    ...
    const getFileCount = async () => {
      try {
        const fileCountResponse = await fetch(
          "https://ai-impact-ranking-server.onrender.com/api/get/records-count-by-status"
        );
      ...
      if (selectedSDG) {
        try {
          const setRecordsResponse = await fetch(
            `https://ai-impact-ranking-server.onrender.com/api/get/records-pero-question/${selectedSDG}`,
            {
              method: "GET",
              headers: {
